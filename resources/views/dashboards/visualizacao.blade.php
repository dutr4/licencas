...
<html>
<head>
    <title>VIsualização Dashboard</title>
</head>
<body>

<div>
    <label>Divisão:</label>
    <select id="filtroDivisao" disabled>
...
fetch('/visualizacao/dashboard/licencas-status')
...
fetch('/visualizacao/dashboard/licencas-em-uso-por-versao')
    .then(response => response.json())
    .then(data => {
...
fetch('/visualizacao/dashboard/licencas-livres-por-versao')
    .then(response => response.json())
    .then(data => {
